...
$sql = "select * from information where catagory = '{$_POST['分类']}' ORDER BY rate_avg DESC";
$count = "select * from information where catagory <= '{$_POST['分类']}' ORDER BY rate_avg DESC";
